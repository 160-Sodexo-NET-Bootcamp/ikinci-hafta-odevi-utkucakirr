...
{   
    ...
    public class ContainerRepository:GenericRepository<Container>,IContainerRepository
    {
        ...
        //Updating process. This method actually converts ContainerUpdateModel to Container model and sending it to generic repository Update method.
        public Task<bool> UpdateWithoutVehicle(ContainerUpdateModel entity)
        {
            var updatedEntity =  _context.Container.Find(entity.Id);
            updatedEntity.ContainerName = entity.ContainerName;
            updatedEntity.Latitude = entity.Latitude;
            updatedEntity.Longtitude = entity.Longtitude;
        ...
        //Converting ContainerViewModel to Container.
        public Container Convert(ContainerViewModel entity)
        {
