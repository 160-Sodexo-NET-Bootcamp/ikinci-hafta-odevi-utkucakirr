...
namespace Data.Repositories.VehicleRepo
{
    ...
    public class VehicleRepository:GenericRepository<Vehicle>,IVehicleRepository
    {
        ...
        //Converting VehicleViewModel to Vehicle.
        public Vehicle Convert(VehicleViewModel entity)
        {
            Vehicle model = new Vehicle {VehicleName = entity.VehicleName, VehiclePlate = entity.VehiclePlate};
            return model;
        }
    }
}
